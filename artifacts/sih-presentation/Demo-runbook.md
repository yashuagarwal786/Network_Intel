...
- [Technical evidence brief](../../docs/sih/SIH-FIRST-ROUND-EVIDENCE.md), [scope freeze](../../docs/sih/SIH-SCOPE-FREEZE.md) and [judge Q&A](../../docs/sih/SIH-JUDGE-QA.md).
...
- [Cycle report](../../docs/cycles/CYCLE-6.md) and [screen audit](../../docs/audits/CYCLE-6-AUDIT.md).
